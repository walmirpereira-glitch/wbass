  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
        ...
        >
          A Arte da
          <span className="block text-gradient-gold">Sofisticação</span>
        </motion.h1>
        ...
        >
          Descubra peças únicas criadas com maestria e atenção aos mínimos detalhes.
          Cada item conta uma história de tradição e excelência.
        </motion.p>
        ...
        >
          <Button variant="luxuryFilled" size="xl">
            Ver Coleção
          </Button>
